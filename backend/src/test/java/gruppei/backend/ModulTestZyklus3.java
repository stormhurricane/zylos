...
import gruppei.backend.controller.BewertungsController;
...
import gruppei.backend.repository.*;
...
public class ModulTestZyklus3 {
    ...
    public void modulTest1() {
        ...
        gruppei.backend.database.Test bewertung = new gruppei.backend.database.Test(1, "Bewertung");
        bewertung.setId(1);
        ...
        gruppei.backend.database.Test quiz = new gruppei.backend.database.Test(1, "Quiz");
        quiz.setId(2);
        List<gruppei.backend.database.Test> quize = new ArrayList<>();
        quize.add(quiz);
        Mockito.when(testRepository.findAllByLvIdAndTestArt(1, gruppei.backend.database.Test.testArtEnum.QUIZ)).thenReturn(quize);
